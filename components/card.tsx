  ...
  return (
    ...
    >
      ...
      <div className="job-card-buttons flex items-center justify-between w-full mt-1 gap-4">
        <a
          href={job.link}
          className="search-buttons card-buttons appearance-button border-none text-button-color inline-block text-center bg-active-color p-[10px] w-full rounded-md text-xs cursor-pointer font-medium mt-[14px]"
        >
          Apply Now
        </a>
        <Link
          href={`/jobs/${job.id}`}
          className="search-buttons card-buttons-msg  border-none text-subtitle-color inline-block text-center bg-inactive-color p-[10px] w-full  rounded-md text-xs cursor-pointer font-medium mt-[14px]"
        >
          Overview
        </Link>
      </div>
