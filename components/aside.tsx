      ...
      <div className="sidebar sticky top-0 shadow-none w-full z-initial opacity-100">
        ...
        <div className="side-options">
          <div className="job-time type pt-5">
            <div className="job-time-title text-[14px] text-sm font-medium">
              Type of Employment
            </div>
            <div className="job-wrapper pt-5">
              {types.map((type) => (
                <div className="type-container flex items-center text-subtitle-color cursor-pointer text-[13px] mt-[10px]">
                  ...
                  />
                  <label className="ml-[2px] flex items-center cursor-pointer before:content=['] before:mr-[10px] before:border before:border-subtitle-color before:rounded before:cursor-pointer before:w-4 before:h-4">{type.title} Jobs</label>
                  <span className="job-number ml-auto bg-inactive-color text-subtitle-color text-[10px] font-medium p-1 rounded-[4px]">{type.count}</span>
                </div>
              ))}
            </div>
          </div>
          <div className="job-time level pt-5">
            ...
            <div className="job-wrapper">
              {seniority.map((e) => (
                <div className="type-container flex items-center text-subtitle-color cursor-pointer text-[13px] mt-[10px]">
                  <input type="checkbox" id="job7" className="job-style hidden" />
                  <label className="ml-[2px] flex items-center cursor-pointer before:content=['] before:mr-[10px]  before:border before:border-subtitle-color before:rounded before:cursor-pointer before:w-4 before:h-4">{e.title} Level</label>
                  <span className="job-number ml-auto bg-inactive-color text-subtitle-color text-[10px] font-medium p-1 rounded-[4px]">{e.count}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="job-time salary pt-5">
            ...
            <div className="job-wrapper">
              {salary.map(s => (
              <div className="type-container flex items-center text-subtitle-color cursor-pointer text-[13px] mt-[10px]">
                <input type="checkbox" id="job1" className="job-style hidden" />
                ...
                <span className="job-number ml-auto bg-inactive-color text-subtitle-color text-[10px] font-medium p-1 rounded-[4px]">{s.count}</span>
              </div>
              ))}
            </div>
          </div>
